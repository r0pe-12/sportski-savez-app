...
PUML_TO_IMAGE = {
    ...
    "07-activity-uc5": ("Slika 8: Activity dijagram UC5 — prijava ekipe", "uml/render/07-activity-uc5.png"),
    "08-activity-uc8": ("Slika 9: Activity dijagram UC8 — eDnevnik verifikacija (5 HTTP grana)", "uml/render/08-activity-uc8.png"),
    "09-state-team": ("Slika 10: State machine — Team životni ciklus", "uml/render/09-state-team.png"),
    "10-state-medical-certificate": ("Slika 11: State machine — MedicalCertificate", "uml/render/10-state-medical-certificate.png"),
    "11-state-student-verification": ("Slika 12: State machine — Student.verification_status", "uml/render/11-state-student-verification.png"),
    "12-er-diagram": ("Slika 13: ER dijagram — logički model baze", "uml/render/12-er-diagram.png"),
    "13-object-diagram": ("Slika 14: Object dijagram — snapshot demo data-e", "uml/render/13-object-diagram.png"),
}
